...
gcc -o chargedParticleMotion -L$TACC_GSL_LIB -L$HOME/bin/grvy/lib -Wl,-rpath,$HOME/bin/grvy/lib chargedParticleMotion.o funcsandjacs.o -lgsl -lgslcblas -lm -lgrvy
